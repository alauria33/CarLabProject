//ssh root@10.9.146.228
//
//mjpg_streamer -i "input_uvc.so -d /dev/video0 -r 320x240 -f 10 –q 50" -o "output_http.so -p 8080 -w /www/webcam"
//
//stream is : http://10.9.146.228:8080/?action=stream
//
//
//
//no compression
//
//mjpg_streamer -i "input_uvc.so -d /dev/video0 -r 320x240 -f 10" -o "output_http.so -p 8080 -w /www/webcam"
//
